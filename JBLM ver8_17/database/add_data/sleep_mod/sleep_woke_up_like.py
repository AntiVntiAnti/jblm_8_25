...
def add_woke_up_like_data(main_window_instance,
                          widget_names,
                          db_insert_method):
    try:
        widget_methods = {
            widget_names['sleep_date']: (None, 'date', 'yyyy-MM-dd'),
            widget_names['woke_up_like']: (None, 'value', None),
        }
